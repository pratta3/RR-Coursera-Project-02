...
Step 1: Download and read the dataset into R. This should take about 30 seconds.
...
# Make the plot
pal <- brewer.pal(6, "Paired")[5:6] # custom color palette
...
# title2, plot2, and caption2 will be passed as arguments to grid.arrange()
...
Not surprisingly, many of the storm types were present in both plots, indicating that the types of storms that
tend to cause a lot of damage tend to be the same types of storms that injure and kill people.
<br>
